...
<div class="flex items-center justify-center h-screen">
  <v-app>
    ...
    <v-card class="mx-auto" max-width="mx-auto">
        <v-expansion-panels v-model="panel" :readonly="readonly" multiple>            
            <v-app-bar-title>CUARTO SEMESTRE</v-app-bar-title>
      <v-expansion-panel>
        

        <v-expansion-panel-title class="primary" theme="dark" color="light-blue-darken-4">
  ...
  <v-icon left>mdi-star</v-icon>  Parcial 2
      ...
      <v-expansion-panel>
        ...
        <v-expansion-panel-title class="primary" theme="dark" color="grey-darken-4">
