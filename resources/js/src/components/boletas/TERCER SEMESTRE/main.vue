...
<div class="flex items-center justify-center h-screen">
  <v-app>
    ...
    <v-card class="mx-auto" max-width="mx-auto">
        <v-expansion-panels v-model="panel" :readonly="readonly" multiple>            
            <v-app-bar-title>TERCER SEMESTRE</v-app-bar-title>
      <v-expansion-panel>
  ...
  <v-icon left>mdi-star</v-icon>  Parcial 1
      ...
      <v-expansion-panel>
        ...
        <v-expansion-panel-title class="primary" theme="dark" color="brown-darken-4">
  <v-icon left>mdi-star</v-icon>  Parcial 2
      ...
      <v-expansion-panel>
        ...
        <v-expansion-panel-title class="primary" theme="dark" color="deep-orange-darken-1">
