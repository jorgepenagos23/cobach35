  ...
  <div class="items-center w-full max-w-screen-lg mx-auto">
    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
      <div class="md:pr-12">
        ...
        <h3 class="mb-4 text-xl font-semibold text-gray-400">Conditioning installation packages</h3>
      ...
      <div class="relative flex flex-col pr-0 overflow-hidden md:pr-16 group">
        <div class="absolute top-0 right-0 w-full px-4 transition-all bg-blue-500 md:w-4/6 md:px-12 py-14 rounded-xl group-hover:bg-sky-600 ">
        ...
        <a class="flex items-center gap-2 mt-2 mb-8 text-sm font-bold" href="#">
