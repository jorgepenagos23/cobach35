    ...
    >
      <v-expansion-panel>
        ...
        <div class="w-full mb-6 lg:mb-0">
                <h1 class="justify-center mb-4 text-3xl text-blue-950">
...
​
        ...
        <div class="p-6 bg-white rounded-lg">
          <img class="object-cover object-center w-full mb-6 rounded lg:h-60 xl:h-56 md:h-64 sm:h-72 xs:h-72 h-72" src="https://images.immediate.co.uk/production/volatile/sites/7/2019/07/33-GettyImages-154260931-216706f.jpg?quality=90&resize=768%2C574" alt="Image Size 720x400">
