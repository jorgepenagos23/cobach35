    ...
    <body style="overflow-x: auto;">
      ...
      <div v-for="publicacion in publicacionesFiltradas" :key="publicacion.id"
        ...
        <div class="items-center w-full max-w-screen-xl mx-auto mt-2 mb-4">
          <div
            class="relative block w-full p-4 text-base leading-5 text-white opacity-100 rounded-xl group-hover:bg-lime-600 bg-teal-950 font-regular">
          ...
          <div class="grid h-full grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div
              class="h-full px-2 py-3 transition-all bg-white w-50 botom-3 md:w-4/6 md:px-2 rounded-xl group-hover:bg-sky-600">
              <h2 class="w-full text-3xl font-bold text-left text-white"></h2>
            </div>
